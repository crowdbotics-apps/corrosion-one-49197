...
export class Api extends ApiBase {
  ...
  payMileage(data: any) {
    return this.simple_post(`${API_VERSION_PREFIX}/jobs/${data.id}/pay_mileage/`, data);
  }
  ...
  addCard(data: any) {
    return this.simple_post(`${API_VERSION_PREFIX}/payments/add-card/`, data);
  }
  ...
  createPaymentIntentHeld(data: any) {
    return this.simple_post(`${API_VERSION_PREFIX}/payments/create-payment-intent-link/`, data);
  }
